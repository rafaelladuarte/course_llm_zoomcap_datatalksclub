...
class MCPClient:
    def __init__(self, server_command: List[str]):
        ...
        Args:
            server_command:
            Command to start the server (e.g., ["python", "server.py"])
        """
    ...
    def get_tools(self) -> List[Dict[str, Any]]:
        ...
        if not self.is_initialized:
            raise RuntimeError(
                ...
                "Call initialize() and initialized() first."
            )
    ...
    def list_available_tools(self):
        ...
        for name, tool in self.available_tools.items():
            ...
            if input_schema.get('properties'):
                print("Parameters:")
                for param_name, param_info in input_schema[
                    'properties'
                ].items():
